...
import type { IActionRdfResolveQuadPattern, IActorRdfResolveQuadPatternOutput, IActorRdfResolveQuadPatternArgs } from './ActorRdfResolveQuadPattern';
...
export declare abstract class ActorRdfResolveQuadPatternSource extends ActorRdfResolveQuadPattern {
     ...
     *                                                      a data RDFJS stream.
     */
    protected getOutput(source: IQuadSource, pattern: RDF.BaseQuad, context: IActionContext): Promise<IActorRdfResolveQuadPatternOutput>;
    /**
...
export interface IQuadSource {
     ...
     */
    match: (subject: RDF.Term, predicate: RDF.Term, object: RDF.Term, graph: RDF.Term, context?: IActionContext) => AsyncIterator<RDF.Quad>;
}
