...
export declare abstract class LinkedRdfSourcesAsyncRdfIterator extends BufferedIterator<RDF.Quad> implements RDF.Stream {
    ...
    constructor(cacheSize: number, subject: RDF.Term, predicate: RDF.Term, object: RDF.Term, graph: RDF.Term, firstUrl: string, maxIterators: number, options?: BufferedIteratorOptions);
     ...
     * @protected
     */
    protected abstract accumulateMetadata(accumulatedMetadata: MetadataQuads, appendingMetadata: MetadataQuads): Promise<MetadataQuads>;
    /**
