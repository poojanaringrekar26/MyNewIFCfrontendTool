...
export declare class ActorQueryOperationSparqlEndpoint extends ActorQueryOperation {
     ...
     */
    executeQuery(endpoint: string, query: string, quads: boolean, variables: RDF.Variable[] | undefined, canContainUndefs: boolean): IQueryOperationResult;
    /**
     * Inspect the query to determine if the query could produce undefined bindings values.
     * @param operation A query operation.
     */
    canOperationContainUndefs(operation: Algebra.Operation): boolean;
}
