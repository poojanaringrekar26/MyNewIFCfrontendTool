 ...
 */
export declare class ActorInitQueryBase<QueryContext extends IQueryContextCommon = IQueryContextCommon> extends ActorInit implements IActorInitQueryBaseArgs<QueryContext> {
    ...
    readonly contextKeyShortcutsExtensions?: (Record<string, string> | Partial<Record<keyof Omit<QueryContext, keyof IQueryContextCommon>, string>>)[];
    /**
...
export interface IActorInitQueryBaseArgs<QueryContext extends IQueryContextCommon = IQueryContextCommon> extends IActorInitArgs {
    /**
     ...
     * ```
     */
    contextKeyShortcutsExtensions?: (Record<string, string> | Partial<Record<keyof Omit<QueryContext, keyof IQueryContextCommon>, string>>)[];
}
