...
`;
        ...
        if (args.httpRetryDelay) {
            ...
            context[context_entries_1.KeysHttp.httpRetryDelay.name] = args.httpRetryDelay;
        }
        ...
        if (args.httpRetryOnServerError) {
            ...
            context[context_entries_1.KeysHttp.httpRetryOnServerError.name] = args.httpRetryOnServerError;
        }
