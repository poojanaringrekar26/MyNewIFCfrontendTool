  ...
  "components": [
    {
      ...
      "extends": [
        {
          ...
          "component": "caiq:components/ActorInitQueryBase.jsonld#ActorInitQueryBase",
          "genericTypeInstances": [
            {
              "@type": "ParameterRangeGenericTypeReference",
              "parameterRangeGenericType": "caiq:components/ActorInitQuery.jsonld#ActorInitQuery__generic_QueryContext"
            }
          ]
        }
      ],
      ...
      "parameters": [
        ...
        {
          "@id": "caiq:components/ActorInitQuery.jsonld#ActorInitQuery_args_contextKeyShortcutsExtensions",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
