 ...
 */
class RdfSourceQpf {
    constructor(mediatorMetadata, mediatorMetadataExtract, mediatorDereferenceRdf, subjectUri, predicateUri, objectUri, graphUri, url, metadata, context, initialQuads) {
