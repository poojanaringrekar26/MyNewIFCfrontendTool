...
import type { IQuadSource, MediatorRdfResolveQuadPattern } from '@comunica/bus-rdf-resolve-quad-pattern';
...
export declare class FederatedQuadSource implements IQuadSource {
    ...
    constructor(mediatorResolveQuadPattern: MediatorRdfResolveQuadPattern, mediatorRdfMetadataAccumulate: MediatorRdfMetadataAccumulate, context: IActionContext, emptyPatterns: Map<IDataSource, RDF.Quad[]>, skipEmptyPatterns: boolean);
    /**
     ...
     */
    static deskolemizeQuad<Q extends RDF.BaseQuad = RDF.Quad>(quad: Q, sourceId: string): Q;
    /**
