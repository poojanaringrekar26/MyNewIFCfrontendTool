 ...
 */
export declare abstract class ActorRdfMetadataAccumulate extends Actor<IActionRdfMetadataAccumulate, IActorTest, IActorRdfMetadataAccumulateOutput> {
    /**
    * @param args - @defaultNested {<default_bus> a <cc:components/Bus.jsonld#Bus>} bus
    */
    constructor(args: IActorRdfMetadataAccumulateArgs);
}
export declare type IActionRdfMetadataAccumulate = IActionRdfMetadataAccumulateInitialize | IActionRdfMetadataAccumulateAppend;
...
export declare type IActorRdfMetadataAccumulateArgs = IActorArgs<IActionRdfMetadataAccumulate, IActorTest, IActorRdfMetadataAccumulateOutput>;
export declare type MediatorRdfMetadataAccumulate = Mediate<IActionRdfMetadataAccumulate, IActorRdfMetadataAccumulateOutput>;
