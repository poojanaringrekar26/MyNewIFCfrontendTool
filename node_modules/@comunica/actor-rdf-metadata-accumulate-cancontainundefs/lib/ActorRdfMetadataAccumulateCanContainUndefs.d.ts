 ...
 */
export declare class ActorRdfMetadataAccumulateCanContainUndefs extends ActorRdfMetadataAccumulate {
    constructor(args: IActorRdfMetadataAccumulateArgs);
    test(action: IActionRdfMetadataAccumulate): Promise<IActorTest>;
