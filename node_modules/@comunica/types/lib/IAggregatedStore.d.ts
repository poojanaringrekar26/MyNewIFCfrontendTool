 ...
 */
export interface IAggregatedStore<Q extends RDF.BaseQuad = RDF.Quad, S extends RDF.Store<Q> = RDF.Store<Q>> extends RDF.Source<Q>, RDF.Sink<RDF.Stream<Q>, EventEmitter> {
    /**
