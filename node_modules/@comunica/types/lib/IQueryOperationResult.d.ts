 ...
 */
export interface IQueryOperationResultStream<M extends IMetadata<OrderItemsType>, OrderItemsType extends RDF.Variable | RDF.QuadTermName> extends IQueryOperationResultBase {
    /**
 ...
 */
export declare type IQueryOperationResult = IQueryOperationResultBindings | IQueryOperationResultQuads | IQueryOperationResultBoolean | IQueryOperationResultVoid;
/**
...
export interface IQueryQuadsEnhanced extends QueryQuads {
    execute: (opts?: RDF.QueryExecuteOptions<RDF.QuadTermName>) => Promise<AsyncIterator<RDF.Quad> & RDF.ResultStream<RDF.Quad>>;
}
export declare type QueryBindings = RDF.QueryBindings<RDF.AllMetadataSupport>;
export declare type QueryQuads = RDF.QueryQuads<RDF.AllMetadataSupport>;
/**
 ...
 */
export declare type QueryEnhanced = IQueryBindingsEnhanced | IQueryQuadsEnhanced | RDF.QueryBoolean | RDF.QueryVoid;
/**
 * Different manners in which a query can be explained.
 */
export declare type QueryExplainMode = 'parsed' | 'logical' | 'physical';
/**
